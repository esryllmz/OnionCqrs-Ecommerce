...
public sealed class CategoryAddCommand : IRequest<CategoryAddedResponseDto>, ILoginRequest
{
  ...
  public sealed class CategoryAddCommandHandler(IMapper _mapper, ICategoryRepository _categoryRepository, CategoryBusinessRules _businessRules) : IRequestHandler<CategoryAddCommand, CategoryAddedResponseDto>
  {
